  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% Reversing_light_P.Counter1_InitialCount
	  ...
	  ;% Reversing_light_P.Delay_InitialCondition
	  ...
	  ;% Reversing_light_P.Delay1_InitialCondition
	  section.data(16).logicalSrcIdx = 18;
	  section.data(16).dtTransOffset = 15;
	
	  ;% Reversing_light_P.Merge1_InitialOutput
  ...
  ;%**************************
    ...
    ;%
	  ...
	  ;% Reversing_light_B.Delay
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% Reversing_light_B.Delay1
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% Reversing_light_DW.Delay_DSTATE
	  section.data(1).logicalSrcIdx = 5;
	  section.data(1).dtTransOffset = 0;
	
	  ;% Reversing_light_DW.Delay1_DSTATE
	  ...
	  ;% Reversing_light_DW.Counter_RstEphState
	  ...
	  ;% Reversing_light_DW.Counter1_ClkEphState
	  section.data(4).logicalSrcIdx = 12;
	  section.data(4).dtTransOffset = 3;
	
	  ;% Reversing_light_DW.Counter1_RstEphState
	  ...
	  ;% Reversing_light_DW.Counter1_Count
  ...
  targMap.checksum0 = 730387602;
  targMap.checksum1 = 2699510214;
  targMap.checksum2 = 1666159886;
  targMap.checksum3 = 3384290073;
