...
typedef struct {
  uint32_T system_response;            /* '<Root>/convert1' */
} B_untitled_T;
...
struct P_untitled_T_ {
  ...
  real_T Step_YFinal;                  /* Expression: 1
                                        * Referenced by: '<Root>/Step'
                                        */
  real_T sys_gain_Gain;                /* Expression: 1
                                        * Referenced by: '<Root>/sys_gain'
                                        */
  real_T convert_Gain;                 /* Expression: 5/255
                                        * Referenced by: '<Root>/convert'
                                        */
  uint16_T convert1_Gain;              /* Computed Parameter: convert1_Gain
                                        * Referenced by: '<Root>/convert1'
                                        */
