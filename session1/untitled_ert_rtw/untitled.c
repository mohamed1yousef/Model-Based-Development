 ...
 * C/C++ source code generated on : Tue Feb 27 23:38:47 2024
 *
...
void untitled_step(void)
{
  ...
  if (untitled_DW.obj_n.SampleTime != untitled_P.AnalogInput_SampleTime) {
    untitled_DW.obj_n.SampleTime = untitled_P.AnalogInput_SampleTime;
  }

  obj = &untitled_DW.obj_n;
  obj->AnalogInDriverObj.MW_ANALOGIN_HANDLE = MW_AnalogIn_GetHandle(18UL);
  MW_AnalogInSingle_ReadResult
    (untitled_DW.obj_n.AnalogInDriverObj.MW_ANALOGIN_HANDLE, &rtb_AnalogInput_0,
     3);

  /* Gain: '<Root>/convert1' incorporates:
   *  MATLABSystem: '<Root>/Analog Input'
   */
  untitled_B.system_response = (uint32_T)untitled_P.convert1_Gain *
    rtb_AnalogInput_0;
  ...
  /* Gain: '<Root>/convert' incorporates:
   *  Gain: '<Root>/sys_gain'
   */
  u0 = untitled_P.sys_gain_Gain * u0 * untitled_P.convert_Gain;
  ...
  {                                    /* Sample time: [0.001s, 0.0s] */
    rtExtModeUpload(1, (real_T)((untitled_M->Timing.clockTick1) * 0.001));
  }
...
void untitled_initialize(void)
{
  ...
  /* External mode info */
  untitled_M->Sizes.checksums[0] = (1892711342U);
  untitled_M->Sizes.checksums[1] = (2623489804U);
  untitled_M->Sizes.checksums[2] = (981067513U);
  untitled_M->Sizes.checksums[3] = (1698205905U);
...

  {
    ...
    untitled_DW.obj_n.isInitialized = 0L;
    untitled_DW.obj_n.SampleTime = -1.0;
...
void untitled_terminate(void)
{
  ...
  matlabCodegenHandle_matlabCod_b(&untitled_DW.obj_n);
